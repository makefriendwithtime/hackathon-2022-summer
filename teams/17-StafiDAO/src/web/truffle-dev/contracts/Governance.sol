...
contract Governance{
    ...
    struct DAOConfig{
        ...
        // uint investorDownLimit;//投资人数下限5
        // uint investorUpLimit;//投资人数上限500
        ...
        uint marginProportion;//收集人和委托人租赁保证金比例（retToken）1/10
    ...
    //技术方手续费最低限制
    uint constant public daoTechLimit = 1;
    //收集人服务费最低限制
    uint constant public collatorTechLimit = 10;
    //投票参与票数最低比例限制
    uint constant public voterDownLimit = 51;
    //提案编号,顺序递增
    ...
    function initialize(
        ...
        // daoConfig.investorDownLimit = 5;
        // daoConfig.investorUpLimit = 500;
        ...
        daoConfig.redeemTimeLimit =  1;
        daoConfig.zeroTimeLimit =  1;
        daoConfig.marginProportion = 1;
    ...
    // function setInvestorDownLimit(uint _investorDownLimit) public isOwner{
    //     daoConfig.investorDownLimit = _investorDownLimit;
    // }      

    // function setInvestorUpLimit(uint _investorUpLimit) public isOwner{
    //     daoConfig.investorUpLimit = _investorUpLimit;
    // }      
    ...
    // //开启投资人数最低下限治理
    // function startIDLGovern(uint _investorDownLimit,uint256 _startDate,uint256 _endDate) public isGovernance{
    //     _setGovern(_investorDownLimit, '', 4, _startDate, _endDate);
    // }

    // //开启投资人数上限治理
    // function startIULGovern(uint _investorUpLimit,uint256 _startDate,uint256 _endDate) public isGovernance{
    //     _setGovern(_investorUpLimit, '', 5, _startDate, _endDate);
    // }
    ...
    // //投资人数最低下限治理投票
    // function voteIDLByNumber(uint _number,uint _state) public {
    //     (bool success,uint uintValue) = _setVote(4, _number, _state);
    //     if(success){
    //         //治理成功
    //         daoConfig.investorDownLimit = uintValue;
    //     }
    // }

    // //投资人数上限治理投票
    // function voteIULByNumber(uint _number,uint _state) public {
    //     (bool success,uint uintValue) =  _setVote(5, _number, _state);
    //     if(success){
    //         //治理成功
    //         daoConfig.investorUpLimit = uintValue;
    //     }
    // }
    ...
    // //查看投资人数下限
    // function getInvestorDownLimit() public  view returns(uint){
    //     return daoConfig.investorDownLimit;
    // }      

    // //查看投资人数上限
    // function getInvestorUpLimit() public  view returns(uint){
    //     return daoConfig.investorUpLimit;
    // }      
