<template>
	<scroll-view class="page-view" scroll-y>
		...
		<view v-if="usertype == '123456'" :class="menushow ? 'more-menu showm' : 'more-menu'">
			<view class="mm-one" @click="toPage('/pages/index/pledge')">Mint</view>
			<view class="mm-one" @click="toPage('/pages/index/user')">钱包</view>
			<view class="mm-one" @click="toPage('/pages/index/exchange')">Swap</view>
			<view class="mm-one" @click="toPage('/pages/index/government')">社区治理</view>
			<view class="mm-one" @click="toPage('/pages/index/mine')">我的</view>
			<view class="mm-one" @click="toPage('/pages/index/createDAO')">创建DAO</view>
			<view class="mm-one" @click="toPage('/pages/index/redeem')">计划赎回/赎回</view>
			<view class="mm-one" @click="toPage('/pages/index/governanceView')">governanceView</view>
			<view class="mm-one" @click="loginOut">退出</view>
		</view>
		<view v-else-if="usertype == '654321'" :class="menushow ? 'more-menu showm' : 'more-menu'">
			<view class="mm-one" @click="toPage('/pages/index/swap')">Swap</view>
			<view class="mm-one" @click="toPage('/pages/index/faucet')">Faucet</view>
			<view class="mm-one" @click="toPage('/pages/index/set')">Set</view>
			<view class="mm-one" @click="loginOut">退出</view>
		</view>
		<!--卡片-->
		...
		<view class="btn-box" v-if="usertype == '123456'">
			<div class="light-btn" @click="toPage('/pages/index/pledge')">Mint To DAO Pool</div>
		</view>
		<!--数据统计-->
